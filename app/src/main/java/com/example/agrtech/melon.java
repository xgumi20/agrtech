...
public class melon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(melon.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(melon.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(melon.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(melon.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(melon.this);
