...
public class Eggplant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(Eggplant.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(Eggplant.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(Eggplant.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(Eggplant.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(Eggplant.this);
