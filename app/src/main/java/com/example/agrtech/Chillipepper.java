...
public class Chillipepper extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chillipepper);
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(Chillipepper.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(Chillipepper.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(Chillipepper.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(Chillipepper.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(Chillipepper.this);
