...
public class Bittergouard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bittergouard);
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(Bittergouard.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(Bittergouard.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(Bittergouard.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(Bittergouard.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(Bittergouard.this);
