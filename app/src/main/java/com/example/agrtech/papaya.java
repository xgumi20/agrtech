...
public class papaya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(papaya.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(papaya.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(papaya.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(papaya.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(papaya.this);
