...
public class SWEETCORN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(SWEETCORN.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(SWEETCORN.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(SWEETCORN.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(SWEETCORN.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(SWEETCORN.this);
