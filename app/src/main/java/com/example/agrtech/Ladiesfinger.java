...
public class Ladiesfinger extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ladiesfinger);
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(Ladiesfinger.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(Ladiesfinger.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(Ladiesfinger.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(Ladiesfinger.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(Ladiesfinger.this);
