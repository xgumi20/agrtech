...
public class watermelon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(watermelon.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(watermelon.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(watermelon.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(watermelon.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(watermelon.this);
