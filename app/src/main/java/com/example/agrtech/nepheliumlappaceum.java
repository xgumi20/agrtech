...
public class nepheliumlappaceum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nepheliumlappaceum);
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(nepheliumlappaceum.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(nepheliumlappaceum.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(nepheliumlappaceum.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(nepheliumlappaceum.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(nepheliumlappaceum.this);
