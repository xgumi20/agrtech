...
public class Squash extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(Squash.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(Squash.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(Squash.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(Squash.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(Squash.this);
