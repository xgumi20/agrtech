...
public class pineapple extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(pineapple.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(pineapple.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(pineapple.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(pineapple.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(pineapple.this);
