...
public class COCONUT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(COCONUT.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(COCONUT.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(COCONUT.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(COCONUT.this, R.anim.rotate_backward);
        ...
        fab2_CalPlant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float rowSpacing = 7.5f;
                float plantSpacing = 7.5f;
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(COCONUT.this);
