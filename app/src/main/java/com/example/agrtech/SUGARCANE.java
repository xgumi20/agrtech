...
public class SUGARCANE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(SUGARCANE.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(SUGARCANE.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(SUGARCANE.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(SUGARCANE.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(SUGARCANE.this);
