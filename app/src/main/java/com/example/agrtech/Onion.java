...
public class Onion extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(Onion.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(Onion.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(Onion.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(Onion.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(Onion.this);
