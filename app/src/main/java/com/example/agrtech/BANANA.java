...
public class BANANA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Animation
        fabOpen = AnimationUtils.loadAnimation(BANANA.this, R.anim.fab_open);
        fabClose = AnimationUtils.loadAnimation(BANANA.this, R.anim.fab_close);
        rotateForward = AnimationUtils.loadAnimation(BANANA.this, R.anim.rotate_forward);
        rotateBackward = AnimationUtils.loadAnimation(BANANA.this, R.anim.rotate_backward);
    ...
    public void potash(View view) {
        builder = new MaterialAlertDialogBuilder(BANANA.this);
